...
public class FeedParser {
    ...
    //New aux functions to create big data

    public static void articlesToFile(List<Article> articles, String filePath) {
    ...
    public static List<Article> fileToArticles(String filename){
        List<Article> articles = new ArrayList<>();
        try (BufferedReader reader = new BufferedReader(new FileReader(filename))) {
            ...
            while ((line = reader.readLine()) != null) {
                if (title == "") { // Catching the title
                    title = line;
                } else if (description == "") { // Catching the description
                    description = line;
                } else { //Creating the article
                    articles.add(new Article(title, description, null, null));
                    title = ""; // reset
                    description = ""; // reset
                }
            }
