...
public class UserInterface {
    ...
    public UserInterface() {
        ...
        options.add(new Option("-gf", "--get-file",1));
    ...
    public Config handleInput(String[] args) {
        ...
        return new Config(printFeed, computeNamedEntities, feedKey, statsChoice, heuristicSelected, file);
    }
}
